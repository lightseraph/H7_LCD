...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_obj_set_pos(ui->screen_cont_1, 375, 132);
	...
	lv_style_set_shadow_width(&style_screen_cont_1_main_main_default, 8);
	lv_style_set_shadow_color(&style_screen_cont_1_main_main_default, lv_color_make(0xa6, 0xae, 0xb5));
	lv_style_set_shadow_opa(&style_screen_cont_1_main_main_default, 192);
	lv_style_set_shadow_spread(&style_screen_cont_1_main_main_default, 3);
	...
	lv_style_set_border_color(&style_screen_cont_1_main_main_default, lv_color_make(0x20, 0x81, 0xcf));
	...
	lv_style_set_text_font(&style_screen_btn_1_main_main_default, &lv_font_siyuan_16);
	...
	lv_style_set_text_font(&style_screen_btn_1_main_main_pressed, &lv_font_siyuan_16);
	...
	lv_style_set_text_font(&style_screen_btn_3_main_main_default, &lv_font_siyuan_16);
	...
	lv_style_set_text_font(&style_screen_btn_3_main_main_pressed, &lv_font_siyuan_16);
	...
	lv_style_set_text_font(&style_screen_btn_2_main_main_default, &lv_font_siyuan_16);
	...
	lv_style_set_text_font(&style_screen_btn_2_main_main_pressed, &lv_font_siyuan_16);
	...
	lv_obj_set_pos(ui->screen_slider_1, 465, 342);
	...
	lv_style_set_shadow_width(&style_screen_slider_1_main_main_default, 4);
	...
	lv_style_set_shadow_spread(&style_screen_slider_1_main_main_default, 2);
	...
	lv_obj_set_size(ui->screen_ddlist_1, 242, 30);
	...
	lv_style_set_text_font(&style_screen_ddlist_1_main_main_default, &lv_font_siyuan_16);
	...
	lv_style_set_text_font(&style_screen_ddlist_1_extra_list_selected_checked, &lv_font_siyuan_16);
	...
	lv_style_set_text_font(&style_screen_ddlist_1_extra_list_main_default, &lv_font_siyuan_16);
