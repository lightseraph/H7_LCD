...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_obj_set_pos(ui->screen_cont_1, 364, 78);
	lv_obj_set_size(ui->screen_cont_1, 400, 316);
	...
	lv_style_set_border_opa(&style_screen_cont_1_main_main_default, 206);
	...
	lv_obj_set_pos(ui->screen_label_1, 55, 215);
	...
	lv_style_set_text_font(&style_screen_label_1_main_main_default, &lv_font_SourceHanSansCN_Regular_18);
	...
	lv_obj_set_pos(ui->screen_label_2, 320, 215);
	...
	lv_style_set_text_font(&style_screen_label_2_main_main_default, &lv_font_SourceHanSansCN_Regular_18);
	...
	lv_obj_set_pos(ui->screen_ddlist_1, 80, 130);
	lv_obj_set_size(ui->screen_ddlist_1, 242, 40);
	...
	lv_style_set_text_font(&style_screen_ddlist_1_main_main_default, &lv_font_SourceHanSansCN_Regular_18);
	...
	lv_obj_set_pos(ui->screen_btn_2, 155, 50);
	lv_obj_set_size(ui->screen_btn_2, 90, 35);
	...
	lv_style_set_radius(&style_screen_btn_2_main_main_default, 6);
	...
	lv_style_set_text_font(&style_screen_btn_2_main_main_default, &lv_font_SourceHanSansCN_Regular_18);
	...
	lv_style_set_text_font(&style_screen_btn_2_main_main_pressed, &lv_font_SourceHanSansCN_Regular_16);
	...
	lv_obj_set_pos(ui->screen_btn_1, 35, 50);
	lv_obj_set_size(ui->screen_btn_1, 90, 35);
	...
	lv_style_set_radius(&style_screen_btn_1_main_main_default, 6);
	...
	lv_style_set_text_font(&style_screen_btn_1_main_main_default, &lv_font_SourceHanSansCN_Regular_18);
	...
	lv_style_set_text_font(&style_screen_btn_1_main_main_pressed, &lv_font_SourceHanSansCN_Regular_16);
	...
	lv_obj_set_pos(ui->screen_slider_1, 100, 223);
	lv_obj_set_size(ui->screen_slider_1, 200, 18);
	...
	lv_obj_set_pos(ui->screen_btn_3, 275, 50);
	lv_obj_set_size(ui->screen_btn_3, 90, 35);
	...
	lv_style_set_radius(&style_screen_btn_3_main_main_default, 6);
	...
	lv_style_set_text_font(&style_screen_btn_3_main_main_default, &lv_font_SourceHanSansCN_Regular_18);
	...
	lv_style_set_text_font(&style_screen_btn_3_main_main_pressed, &lv_font_SourceHanSansCN_Regular_16);
	...
	lv_obj_set_pos(ui->screen_sw_1, 91, 371);
	lv_obj_set_size(ui->screen_sw_1, 55, 30);
	...
	lv_obj_set_pos(ui->screen_sw_2, 203, 371);
	lv_obj_set_size(ui->screen_sw_2, 55, 30);
	...
	lv_obj_set_pos(ui->screen_label_3, 700, 2);
	...
	ui->screen_tabview_1 = lv_tabview_create(ui->screen, LV_DIR_TOP, 45);
	lv_obj_set_pos(ui->screen_tabview_1, 40, 78);
	lv_obj_set_size(ui->screen_tabview_1, 295, 250);

	// tab_1
	ui->screen_tabview_1_tab_1 = lv_tabview_add_tab(ui->screen_tabview_1, "tab_1");
	lv_obj_t *screen_tabview_1_tab_1_label = lv_label_create(ui->screen_tabview_1_tab_1);
	lv_label_set_text(screen_tabview_1_tab_1_label, "con1");
	...
	lv_style_set_radius(&style_screen_tabview_1_main_main_default, 10);
	...
	lv_style_set_shadow_width(&style_screen_tabview_1_main_main_default, 10);
	lv_style_set_shadow_color(&style_screen_tabview_1_main_main_default, lv_color_make(0xc8, 0xd4, 0xdf));
	lv_style_set_shadow_opa(&style_screen_tabview_1_main_main_default, 192);
	lv_style_set_shadow_spread(&style_screen_tabview_1_main_main_default, 5);
	lv_style_set_shadow_ofs_x(&style_screen_tabview_1_main_main_default, 2);
	lv_style_set_shadow_ofs_y(&style_screen_tabview_1_main_main_default, 2);
	lv_style_set_border_color(&style_screen_tabview_1_main_main_default, lv_color_make(0x37, 0x8a, 0xcd));
	lv_style_set_border_width(&style_screen_tabview_1_main_main_default, 2);
	lv_style_set_border_opa(&style_screen_tabview_1_main_main_default, 204);
	lv_style_set_text_color(&style_screen_tabview_1_main_main_default, lv_color_make(0x4d, 0x4d, 0x4d));
	lv_style_set_text_font(&style_screen_tabview_1_main_main_default, &lv_font_SourceHanSansCN_Regular_16);
	...
	lv_style_set_radius(&style_screen_tabview_1_extra_btnm_main_default, 5);
	lv_style_set_bg_color(&style_screen_tabview_1_extra_btnm_main_default, lv_color_make(0xfd, 0xfc, 0xed));
	...
	lv_style_set_border_opa(&style_screen_tabview_1_extra_btnm_main_default, 206);
	...
	lv_style_set_text_font(&style_screen_tabview_1_extra_btnm_items_default, &lv_font_SourceHanSansCN_Regular_15);
	...
	lv_style_set_text_font(&style_screen_tabview_1_extra_btnm_items_checked, &lv_font_SourceHanSansCN_Regular_16);
